...
namespace Drupal\soccerbet_team\Entity;
...
use Drupal\soccerbet_team\SoccerbetTeamInterface;
 ...
 *     "list_builder" = "Drupal\soccerbet_team\SoccerbetTeamListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "access" = "Drupal\soccerbet_team\SoccerbetTeamAccessControlHandler",
 *     "form" = {
 *       "add" = "Drupal\soccerbet_team\Form\SoccerbetTeamForm",
 *       "edit" = "Drupal\soccerbet_team\Form\SoccerbetTeamForm",
...
class SoccerbetTeam extends ContentEntityBase implements SoccerbetTeamInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['team_name_code'] = BaseFieldDefinition::create('list_string')
      ...
      ->setDescription(t('The shortcode of this team. This shortcode refers to the flag which is stored in the flages directory.'))
      ->setSettings([
        'allowed_values' => [
          "AE" => "AE ",
          "AF" => "AF ",
