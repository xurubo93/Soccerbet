...
namespace Drupal\soccerbet_tournament\Entity;
...
use Drupal\soccerbet_tournament\SoccerbetTournamentInterface;
 ...
 *     "list_builder" = "Drupal\soccerbet_tournament\SoccerbetTournamentListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "form" = {
 *       "add" = "Drupal\soccerbet_tournament\Form\SoccerbetTournamentForm",
 *       "edit" = "Drupal\soccerbet_tournament\Form\SoccerbetTournamentForm",
 ...
 *     "canonical" = "/soccerbet_tournament/{soccerbet_tournament}",
...
class SoccerbetTournament extends ContentEntityBase implements SoccerbetTournamentInterface {
  ...
  public function setStartAndEndDate($start_and_end_date) {
